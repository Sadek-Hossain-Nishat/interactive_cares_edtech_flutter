...
class CousreItemView {
        ...
        onTap: () {
          Get.to(
              CourseDetailsPage(
                  ...
                  videoId: yvideoId(course_video),
                  videolist: videolist,
                  ids: yvideoIds(videolist)),
              duration:
  ...
  static Widget videotileimg(String url) {
    final videoId = YoutubePlayer.convertUrlToId(url);
    return Image.network(YoutubePlayer.getThumbnail(videoId: videoId!),
        height: 50.h, width: 50.w);
  }

  static String yvideoId(String url) {
    final videoId = YoutubePlayer.convertUrlToId(url) as String;
    return videoId;
  }

  static List<String> yvideoIds(List<String> urls) {
    List<String> ids = [];
    for (int i = 0; i < urls.length; i++) {
      final videoId = YoutubePlayer.convertUrlToId(urls[i]) as String;
      ids.add(videoId);
    }
